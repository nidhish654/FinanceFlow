...
//                         <div
//                             className={`mt-4 text-4xl font-bold ${config.amountClass}`}
//                         >
//                             <CurrencyAmount
...
//                     <div className="grid gap-x-16 gap-y-2 px-6 py-6 md:grid-cols-2">
    ...
    return (
        ...
        >
            <DialogContent className="w-[95vw] max-w-5xl overflow-hidden rounded-xl p-0">
                <DialogHeader className="border-b px-5 py-5 md:px-10 md:py-8">
                ...
                <div className="max-h-[82vh] overflow-y-auto">
                    <div className="flex flex-col items-center px-4 py-5 md:px-4 md:py-4">
                        <Badge
                            variant="outline"
                        ...
                        <div
                            className={`mt-4 text-3xl font-bold md:text-4xl ${config.amountClass}`}
                        >
                            <CurrencyAmount
                                amount={transaction.amount}
                                currency="INR"
                    ...
                    <div className="grid gap-x-8 gap-y-1 px-4 py-5 md:gap-x-16 md:gap-y-2 md:px-6 md:py-6">
                                                <DetailRow
                            icon={Wallet}
                            label="Account"
                            value={transaction.account.name}
                    ...
                    {(transaction.description ||
                        ...
                        <>
                            ...
                            <div className="space-y-3 px-4 py-4 md:px-4 md:py-4">
                                {transaction.description && (
                                    <Card className="shadow-none">
